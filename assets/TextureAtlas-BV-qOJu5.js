import{F as e,I as t,P as n,Y as r,b as i,ct as a,d as o,g as s,n as c,ot as l,t as u,u as d,z as f}from"./three.module-SCzVhMNL.js";import{a as p}from"./math-Ddn6G0Bv.js";import{t as m}from"./Bitmap-za_UbnjG.js";var h=function(e){return e[e.Instancing=0]=`Instancing`,e[e.Merging=1]=`Merging`,e}({}),g=class extends e{batchMode;isBatchedMesh=!0;opacity=1;extraLight=new a(0,0,0);paletteIndex=0;clippingPlanes=[];clippingPlanesHash=``;constructor(e,t,n=h.Instancing){super(e,t),this.geometry=e,this.material=t,this.batchMode=n,this.castShadow=!1,this.layers.disable(0),this.layers.enable(1)}getOpacity(){return this.opacity}setOpacity(e){this.opacity=e}getExtraLight(){return this.extraLight}setExtraLight(e){this.extraLight=e}getPaletteIndex(){return this.paletteIndex}setPaletteIndex(e){this.paletteIndex=e}getClippingPlanes(){return this.clippingPlanes}setClippingPlanes(e){this.clippingPlanes=e,this.updateClippingPlanesHash(e)}updateClippingPlanesHash(e){this.clippingPlanesHash=e.map(e=>[...e.normal.toArray(),e.constant]).flat().join(`,`)}getClippingPlanesHash(){return this.clippingPlanesHash}},_={uniforms:{palette:{type:`t`,value:null},paletteOffsetCount:{value:[0,1]},extraLight:{value:new a(0,0,0)}},instanceParsVertex:`
...
`,vertexColorMultFrag:`
  ...
  #endif
`},v={uniforms:l.merge([c.basic.uniforms,_.uniforms]),vertexShader:u.meshbasic_vert.replace(`#include <common>`,`#include <common>
...
`)),fragmentShader:u.meshbasic_frag.replace(`#include <common>`,`#include <common>
